...
function setup() {
  ...
  tsuma = loadImage("./data/tsumayouji.png");
...
function draw() {
  //---------------maps_draw----------------------------//
  if (map_main == true) {
    image(mapsImage, 0, 0, width, height);
    image(pinImage, 600, 450, 50, 50);
    image(pinImage, 500, 300, 50, 50);
    image(pinImage, 600, 200, 50, 50);
  }
  //-----------------------------------------------------//
